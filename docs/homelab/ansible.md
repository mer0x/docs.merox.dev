...
- <a href="/operations/DevOps/ansible/playbooks/linux-upgrade">:simple-linux: __Linux playbook__ for automatic linux distros upgrade</a>
- <a href="/operations/DevOps/ansible/playbooks/windows-upgrade">:simple-windows95: __Windows playbook__  for automatic windows upgrade</a>
- <a href="/operations/DevOps/ansible/playbooks/proxmox-vm">:simple-proxmox: __Proxmox playbook__ for automatic VM creation</a>
