...
!!! success
    ...
    <div class="grid cards" markdown>
     <a href="/operations/containerization/k3s/installation">:material-transit-connection-variant: __Check configs__ DEPLOY YOUR OWN K3S CLUSTER</a>
    </div>
